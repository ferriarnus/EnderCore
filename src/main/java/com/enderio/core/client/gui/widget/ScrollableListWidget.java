...
public abstract class ScrollableListWidget<T> implements INestedGuiEventHandler {
  ...
  public void drawScreen(int mX, int mY, float partialTick) {
    ...
    final @Nonnull MainWindow mw = mc.getMainWindow();
    final int sx = (int) (minX * mw.getGuiScaleFactor());
    final int sw = (int) (width * mw.getGuiScaleFactor());
    final int sy = (int) (mw.getScaledHeight() - maxY * mw.getGuiScaleFactor());
    final int sh = (int) (height * mw.getGuiScaleFactor());
