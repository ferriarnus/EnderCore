...
public class Mat4d {
  ...
  public Mat4d(double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double m20, double m21, double m22,
  ...
  public Mat4d(FloatBuffer modelview) {
    m00 = modelview.get(0);
    m01 = modelview.get(1);
    m02 = modelview.get(2);
    m03 = modelview.get(3);
  ...
  public void getTranslation(Vec3d trans) {
    trans.x = m03;
    trans.y = m13;
    trans.z = m23;
  }
  ...
  public void transform(Vec4d vec) {
  ...
  public void transformNormal(Vec3d normal) {
    double x = m00 * normal.x + m01 * normal.y + m02 * normal.z;
    double y = m10 * normal.x + m11 * normal.y + m12 * normal.z;
  ...
  public void mul(Mat4d m1, Mat4d m2) {
    set(m1);
    mul(m2);
  }
